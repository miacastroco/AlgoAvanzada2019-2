...
def make_pipeline():
    ...
    workingCapital_winsorized = workingCapital.winsorize(min_percentile=0.05, max_percentile=0.95)
    sGrowRate_winsorized = sGrowRate.winsorize(min_percentile=0.05, max_percentile=0.95)
    dividendYield_winsorized = dividendYield.winsorize(min_percentile=0.05, max_percentile=0.95)

    combined_factor = (
        value_winsorized.zscore() +
        quality_winsorized.zscore() +
        sentiment_score_winsorized.zscore() +
        workingCapital_winsorized +
        sGrowRate_winsorized +
